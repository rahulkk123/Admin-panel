                                            ...
                                            <ul class="products">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        ...
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">{{$items['name'] }}</a></div>
                                                            <div class="price">
                                                                <ins><span class="price-amount"><span class="currencySymbol"></span>{{$items['price'] }}</span></ins>
                                                               
                                                            </div>
                                                            <div class="qty">
                                                                <label for="cart[id123][qty]">Quantity:{{ $items['quantity']  }}</label>
...
@include('sweetalert::alert')
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><a href="#" class="permal-link">Featured products</a></li>
                ...
                <div class="contain-product pr-detail-layout">
                    <div class="product-thumb">
                        <a href="#" class="link-to-product">
                            <img src="assets/images/logo/output-onlinegiftools.gif" height="100" width="200"> 
    ...
    <div class="info">
        ...
        <b class="categories">{{$product->description}}</b>
        ...
        <div class="buttons">
            ...
            <a href="{{ route('add.to.cart', $product->id) }}" class="btn add-to-cart-btn">add to cart</a>
                ...
                <div id="main-content" class="main-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="row">
                           <ul class="products-list">
                                ...
                                <li class="product-item col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                    ...
                                    <div class="contain-product layout-default">
                                        ...
                                        <div class="info">
                                            <b class="categories">{{$item->description}}</b>
